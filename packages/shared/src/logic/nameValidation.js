...
export function validateProjectName(length, requiredError, max = NAME_MAX) {
...
export function stateMessageSuffix(state) {
    switch (state) {
...
export { NAME_MAX as PROJECT_NAME_MAX, NEAR_THRESHOLD as PROJECT_NAME_NEAR, MID_THRESHOLD as PROJECT_NAME_MID, };
