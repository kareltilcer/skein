...
function kc(i) { return KNIT_COLORS[i % KNIT_COLORS.length]; }
function cc(i) { return CROCHET_COLORS[i % CROCHET_COLORS.length]; }
...
export const STITCH_PICKER_GROUPS = [
...
export const PICKER_FILTER_CHIPS = [
    { id: 'all', label: 'All' },
    { id: 'knit', label: 'Knit' },
...
export function getPickerGroups(filter) {
    switch (filter) {
