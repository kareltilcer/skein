...
export function sizesFor(craft) {
    return craft === 'knit' ? KNIT_SIZES : CROCHET_SIZES;
}
export function findEntry(craft, mm) {
    return sizesFor(craft).find((s) => s.mm === mm);
}
export function formatNeedleSize(craft, mm, unit) {
